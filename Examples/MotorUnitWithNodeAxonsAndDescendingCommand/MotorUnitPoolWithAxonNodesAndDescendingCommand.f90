program MotorUnitPoolWithAxonNodesAndDescendingCommand
    ...
    character(len = 80) :: filename = 'confMNPoolWithNodeAxonsAnsDescendingCommand.rmto'
    ...
    do i = 1, size(t)        
        ...
        do j = 1, size(motorUnitPools)
            ...
            MNv_mV(i) = motorUnitPools(j)%v_mV(3)        
        end do
    end do
    toc =  dsecnd()
...
end program MotorUnitPoolWithAxonNodesAndDescendingCommand